/*
 * can_reg_cfg.h - can_reg_cfg.h config header file;
 *
 * Copyright (c) 2014 Forlan.yung(YANGHUALIANG)
 *
 */

#ifndef _CAN_REG_CFG_H_
#define _CAN_REG_CFG_H_
...
/* The following are defines for the bit fields in the CAN_CLK_DIV register */
#define CANCLKDIV_DIVIDED_BY_01 0x00
#define CANCLKDIV_DIVIDED_BY_02 0x01
#define CANCLKDIV_DIVIDED_BY_03 0x02
#define CANCLKDIV_DIVIDED_BY_04 0x03
#define CANCLKDIV_DIVIDED_BY_05 0x04
#define CANCLKDIV_DIVIDED_BY_06 0x05
...
/* The following are deprecated defines for the reset values of the can registers. */
...
/* The following are deprecated defines for the bit fields in the CAN_STS register. */
#define CAN_STS_LEC_MSK         0x00000007  // Last Error Code

/* The following are deprecated defines for the bit fields in the CAN_ERR register. */
...
/* The following are deprecated defines for the bit fields in the CAN_BIT register. */
...
/* The following are deprecated defines for the bit fields in the CAN_INT register. */
#define CAN_INT_INTID_MSK       0x0000FFFF  // Interrupt Identifier

/* The following are deprecated defines for the bit fields in the CAN_TST register. */
#define CAN_TST_TX_MSK          0x00000060  // Overide control of CAN_TX pin

/* The following are deprecated defines for the bit fields in the CAN_BRPE register. */
...
/* The following are deprecated defines for the bit fields in the CAN_TXRQ1 register. */
#define CAN_TXRQ1_TXRQST        0x0000FFFF  // Transmission Request Bits

/* The following are deprecated defines for the bit fields in the CAN_TXRQ2 register. */
#define CAN_TXRQ2_TXRQST        0x0000FFFF  // Transmission Request Bits

/* The following are deprecated defines for the bit fields in the CAN_NWDA1 register. */
#define CAN_NWDA1_NEWDATA       0x0000FFFF  // New Data Bits

/* The following are deprecated defines for the bit fields in the CAN_NWDA2 register. */
#define CAN_NWDA2_NEWDATA       0x0000FFFF  // New Data Bits

/* The following are deprecated defines for the bit fields in the CAN_MSGINT1 register. */
#define CAN_MSGINT1_INTPND      0x0000FFFF  // Interrupt Pending Bits

/* The following are deprecated defines for the bit fields in the CAN_MSGINT2 register. */
#define CAN_MSGINT2_INTPND      0x0000FFFF  // Interrupt Pending Bits

/* The following are deprecated defines for the bit fields in the CAN_MSGVAL1 register. */
#define CAN_MSGVAL1_MSGVAL      0x0000FFFF  // Message Valid Bits

/* The following are deprecated defines for the bit fields in the CAN_MSGVAL2 register. */
